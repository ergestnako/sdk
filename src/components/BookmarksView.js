...
class Bookmarks extends React.PureComponent {
  ...
  constructor(props, context) {
    ...
    this.map = this.props.mapStore || this.props.map;
    this.state = {
      value: null
    }
  }
  ...
  componentDidMount() {
    if (this.props.showMarker) {
      ...
      //TODO: Add layer when addLayer action is implemented
  ...
  _handleChange(evt, value) {
    ...
    for (var i = 0, ii = this.props.bookmarks.length; i < ii; ++i) {
      if (this.props.bookmarks[i].name === value) {
        ...
        this.props.changeExtent(bookmark.extent);
      }
    }
    this.setState({value: value});
  }
  //TODO: Add animation back to change extent action, probable in map component
/*
